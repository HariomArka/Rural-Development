...
//         {grade.toUpperCase()} - {subject.toUpperCase()} - {type.toUpperCase()}
//       </h2>

//       {type === "quiz" && <p>Here you’ll show quiz questions.</p>}
//       {type === "videos" && <p>Here you’ll show embedded videos.</p>}
//       {type === "theory" && <p>Theory notes go here.</p>}
//       {type === "games" && <p>Interactive games here.</p>}
//     </div>
//   );
// }
