...
export default function PhysicsPage() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 relative overflow-hidden">
      {/* Background Video */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-purple-900/60 via-indigo-900/60 to-blue-900/60"></div>
      </div>

      {/* Floating Physics Elements */}
      <div className="absolute top-16 left-8 text-blue-300 text-5xl font-light opacity-20 rotate-12">⚡</div>
      <div className="absolute top-32 right-12 text-purple-300 text-4xl font-light opacity-20 -rotate-12">E=mc²</div>
      <div className="absolute bottom-24 left-16 text-indigo-300 text-3xl font-light opacity-20 rotate-45">F=ma</div>
      <div className="absolute bottom-16 right-24 text-blue-300 text-4xl font-light opacity-20">∆</div>
      <div className="absolute top-1/2 left-4 text-purple-200 text-2xl font-light opacity-15">ℏ</div>
      ...
      <div className="relative z-10 h-screen flex flex-col md:flex-row items-center justify-center px-6 py-8">
        ...
        <div className="flex-1 flex flex-col items-center justify-center mb-4 md:mb-0">
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-500 via-blue-500 to-indigo-500 rounded-xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
            <div className="relative">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Albert_Einstein_Head.jpg/256px-Albert_Einstein_Head.jpg"
                alt="Albert Einstein"
          ...
          <div className="mt-4 max-w-sm text-center">
            ...
            <div className="flex items-center justify-center mt-2">
              <div className="w-10 h-px bg-gradient-to-r from-purple-400 to-blue-400 mr-2"></div>
